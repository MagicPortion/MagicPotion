    ...
    <>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <h2 style={{ fontSize: 16, color: "#c8a84b", margin: 0, letterSpacing: "0.1em" }}>
            📜 レシピ帳
          </h2>
          <button
            onClick={onClose}
            style={{ background: "none", border: "none", cursor: "pointer", fontSize: 18, color: "#8B6914" }}
          >
            ✕
          </button>
        </div>
            ...
            {knownRecipes.map(([recipeId, level]) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ fontSize: 14, fontWeight: "bold", color: "#c8a84b", flex: 1 }}>
                    {potion?.name}
                  </span>
                  <span
                    style={{
                  ...
                  {onSelectRecipe && (
                    <button
                      ...
                      className={css({
                        ...
                        border: "1px solid",
                        borderColor: canBrew ? "pastel.sage" : "#4a3810",
                        borderRadius: "4px",
                        p: "4px 12px",
                        cursor: canBrew ? "pointer" : "not-allowed",
                        fontSize: "12px",
                        color: canBrew ? "#4a3f55" : "#4a3810",
                        whiteSpace: "nowrap",
