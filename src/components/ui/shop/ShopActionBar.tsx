    ...
    >
      <div className={css({ display: "flex", alignItems: "center", gap: "24px" })}>
        ...
        >
          ...
          <span className={css({ fontSize: "24px", fontWeight: "bold", color: "#111" })}>
        ...
        <button
          ...
          style={{
            backgroundColor: canBuy ? "#5bc0f8" : "#bfbfbf",
      ...
      <button
        ...
        className={css({
          ...
          px: "52px",
          py: "16px",
          fontSize: "24px", // ★ 指摘に合わせて 22px から 24px に変更
          fontWeight: "bold",
          cursor: "pointer",
