      ...
      >
        ...
        <div className={css({ flex: 1, overflowY: "auto", px: "64px", py: "0" })}>
          {potions.length === 0 ? (
            ...
            <div className={css({ display: "flex", flexDirection: "column", gap: "20px", pb: "32px" })}>
              {groups.map((g) => (
                <div
        ...
        <div className={css({ flexShrink: 0, px: "64px", py: "32px", display: "flex", flexDirection: "column", gap: "24px", borderTop: "1px solid rgba(255,255,255,0.15)" })}>
          {potions.length > 0 && (
            <div className={css({ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "16px" })}>
